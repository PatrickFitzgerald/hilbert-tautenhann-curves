classdef Solution % not handle
	...
	properties (Access = public)
		...
		memo (1,1) htcurve.SolutionMemo = htcurve.SolutionMemo();
		...
		subSolutions (:,1) htcurve.SolutionPiece = htcurve.SolutionPiece.empty(0,1);
		reconstruction uint8 = uint16.empty(0,0); % will show how to reassemble the pieces into the whole region
	end
	
	% example:
	% reconstruction = [1,4;2,3];
